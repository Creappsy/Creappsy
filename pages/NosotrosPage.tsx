...
const NosotrosPage: React.FC = () => {
    ...
    return (
        <>
            <Section id="nosotros-hero" className="!pt-16 !pb-12 text-center relative overflow-hidden bg-slate-950/50">
            ...
            <Section id="nuestros-valores" className="bg-slate-950/50">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {values.map(value => (
                         <div key={value.title} className="bg-slate-800/50 p-6 rounded-lg border border-slate-700 text-center">
